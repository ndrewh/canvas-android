...
class GradeStatisticsView(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawLine( minX, centerY + MINMAX_HEIGHT/2.0f, minX,centerY - MINMAX_HEIGHT/2.0f, linePaint)
        canvas.drawLine( maxX, centerY + MINMAX_HEIGHT/2.0f, maxX,centerY - MINMAX_HEIGHT/2.0f, linePaint)
        canvas.drawLine( meanX, centerY + ENDMARKER_HEIGHT/2.0f, meanX,centerY - ENDMARKER_HEIGHT/2.0f, darkLinePaint)
